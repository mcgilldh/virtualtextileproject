...
<a  class="popmodal makebutton" href="/cms/page/manage.php?id=<?php print $_POST['pageid'];?>">go back to manage this page</a>
<a	class="makebutton" href="<?php print $cms_url;?><?php print $pageurl;?>">close and reload</a>
<?php	} else {
		?>
<h3>The updates to this page were successful!</h3>
<a class="makebutton"
